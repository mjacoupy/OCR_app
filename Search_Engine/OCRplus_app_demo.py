...
st.text("Ce module OCR+ a été développé par le PTCTech Lab. Il vise à interpréter divers types de documents, tels que des factures, des tickets, des rapports officiels, ou encore des documents financiers")
st.text("Cette démo est un exemple concret du fonctionnement du module l'OCR+ avec différent types de cas. Cependant, il doit être adapté et affiné à votre contexte afin d'être performant")
